...
const BlogPost = () => {
  ...
  return (
    <div
      className='rn-post-area rn-section-gapBottom pt--200 bg-color-grey'
      id='news'
    >
      <div className='container'>
        <div className='row'>
          <div className='col-lg-12'>
            <div className='section-title mb--40'>
              <h2 className='title'>
                Projects <span className='bg'>Portfolio</span>
              </h2>
            </div>
          </div>
        </div>
        <div className='row row--45'>
          {blogs.map((blog) => (
            <div
              className='col-lg-4 col-md-6 col-12 wow fadeInDown'
